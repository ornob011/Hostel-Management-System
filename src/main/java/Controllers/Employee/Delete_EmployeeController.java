...
public class Delete_EmployeeController implements Initializable {
    ...
    @FXML
    private TextField reg_txt_emp_hostel_name;
    @FXML
    ...
    @FXML
    private TableColumn<EmployeeDetails, String> col_hostel_name;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        reg_txt_emp_hostel_name.setDisable(true);
    ...
    private void clearFields() {
        ...
        reg_txt_emp_hostel_name.setText("");
    ...
    private void updateLeavedEmployeeDB() {
        String query = "INSERT INTO leaved_employee (id,name,hostel_name,tel,emg_tel,leave_date) VALUES(?,?,?,?,?,?)";
        connection = DBHandler.connectDB();
        try {
            pst = connection.prepareStatement(query);
            pst.setString(1, emp_id.getText());
            pst.setString(2, reg_txt_emp_username.getText());
            pst.setString(3, reg_txt_emp_hostel_name.getText());
